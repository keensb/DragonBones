...
module modules
{
    export class DragonBonesCopyAnimations
    {
        constructor(displayContainer:egret.DisplayObjectContainer)
        {
            ...
            var armature:dragonBones.Armature = dragonbonesFactory.buildArmature("robot");//④骨架名称(这个最容易被忽略)
            ...
            var anms:dragonBones.AnimationState = armature.animation.gotoAndPlay("Run");//⑤动画关键帧标签名称
