...
module modules
{
    export class DragonBonesCopyAnimations
    {
        constructor(displayContainer:egret.DisplayObjectContainer)
        {
            ...
            dragonbonesFactory.addDragonBonesData(dragonBones.DataParser.parseDragonBonesData(dragonbonesRotbotData));
            //把骨骼动画所需要的纹理集资源添加到工厂纹理集列表中
            dragonbonesFactory.addTextureAtlas(new dragonBones.EgretTextureAtlas(textureRotbot, textureRotbotData));

            dragonbonesFactory.addDragonBonesData(dragonBones.DataParser.parseDragonBonesData(dragonbonesWarriorData));
            dragonbonesFactory.addTextureAtlas(new dragonBones.EgretTextureAtlas(textureWarrior, textureWarriorData));
            ...
            var anmsRobot:dragonBones.AnimationState = armatureRobot.animation.gotoAndPlay("run");//⑤动画关键帧标签名称
            ...
            var anmsWarrior:dragonBones.AnimationState = armatureWarrior.animation.gotoAndPlay("run");//⑤动画关键帧标签名称
